...
![image-20230331112144210](https://s1.vika.cn/space/2023/03/31/15b4e050be9b472ab9c6cec5645e6885)
...
在写完 redo log 之后，数据此时具有 `crash-safe` 能力，因此系统崩溃，数据会恢复成事务开始之前的状态。但是，若在 redo log 写完时候，binlog 写入之前，系统发生宕机。此时 binlog 没有对上面的更新语句进行保存，导致当使用 binlog 进行数据库的备份或者恢复时，就少了上述的更新语句。从而使得 `id=2` 这一行的数据没有被更新。![image-20230331115927720](https://s1.vika.cn/space/2023/03/31/5afd761420354582bb5eb2090c25ebf8)
...
![image-20230331120932011](https://s1.vika.cn/space/2023/03/31/1c19e2a43d6744f387627f1ae3118524)
