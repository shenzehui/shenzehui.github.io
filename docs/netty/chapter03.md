...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_02.png)

### 3.4.2 Buffer 类及其子类

1. 在 `NIO` 中，`Buffer` 是一个顶层父类，它是一个抽象类，类的层级关系图：

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_03.png)

2. `Buffer` 类定义了所有的缓冲区都具有的四个属性来提供关于其所包含的数据元素的信息：

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_05.png)

3. `Buffer` 类相关方法一览

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_06.png)

### 3.4.3 ByteBuffer

从前面可以看出对于 `Java` 中的基本数据类型（`boolean` 除外），都有一个 `Buffer` 类型与之相对应，最常用的自然是 `ByteBuffer` 类（二进制数据），该类的主要方法如下：

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_07.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_08.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_09.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_10.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_11.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_22.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_12.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_13.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_14.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_15.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_17.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_18.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_19.png)

3. 提示：零拷贝从操作系统角度，是没有 `cpu` 拷贝
4. `Linux在2.4` 版本中，做了一些修改，避免了从内核缓冲区拷贝到 `Socketbuffer` 的操作，直接拷贝到协议栈，从而再一次减少了数据拷贝。具体如下图和小结：

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter03_20.png)
