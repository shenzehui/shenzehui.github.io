...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter02_01.png)

4. `Java NIO`：同步非阻塞，服务器实现模式为一个线程处理多个请求（连接），即客户端发送的连接请求都会注册到多路复用器上，多路复用器轮询到连接有 `I/O` 请求就进行处理。【简单示意图】

![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter02_02.png)
...
![](https://javablog-image.oss-cn-hangzhou.aliyuncs.com/blog/chapter02_03.png)
